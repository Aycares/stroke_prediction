...
class ModelRequest(BaseModel):
    ...
    hypertension: int = Field(..., description="indicates if the client has hypertension (No or Yes)",
                     ge=0, le=1, examples=["No","Yes"])
    heart_disease: Literal['No','Yes'] = Field(..., description="indicates if the client has heart disease (No or Yes)",
                     ge=0, le=1, examples=["No","Yes"])
